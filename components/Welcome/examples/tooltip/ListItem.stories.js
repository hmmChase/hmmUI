...
export default {
  title: 'components|Welcome/Design System/tooltip/ListItem',

  decorators: [
    storyFn => (
      <div style={{ width: 200, border: '1px solid #ddd', margin: '3rem' }}>
        {storyFn()}
      </div>
    )
  ],
...
export const activeIcon = () => (
  <ListItem active title='active icon' right={<Icon icon='eye' />} />
);
